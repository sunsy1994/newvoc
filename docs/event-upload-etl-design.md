...
- `templates/event-voc/event_upload_template.xlsx`
- `templates/event-voc/content_upload_template.xlsx`
- `templates/event-voc/comment_upload_template.xlsx`
...
- 输入：`samples/event_voc_etl_sample/input`
- 输出：`samples/event_voc_etl_sample/output`
