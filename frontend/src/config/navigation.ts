...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "报告资产", href: "/assets/reports", icon: FileSearch },
    ],
  },
  {
    label: "竞品动态",
  ...
  },
  {
    ...
    children: [
      ...
      { label: "异常问题记录", href: "/system/agent-error-questions", icon: TriangleAlert },
      { label: "数据血缘维护", href: "/system/data-lineage", icon: GitBranch },
    ],
  },
];
